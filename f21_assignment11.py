# Problem 0
 ...
 # notice this replaces the 1st argument w/ the 2nd
...
df.drop('Zip', inplace=True, axis=1)
	...
	# Problem 3
	#
	# a) Visualize each bivariate relationship among Average_Class_Size,
#Average_Salary, Perc_Economically_Disadvantaged, and Perc_English_Language_Learner.
#Use the Seaborn function pairplot. The argument to pairplot should be 
#school_data[['Average_Class_Size', 'Average_Salary', 'Perc_Economically_Disadvantaged', 'Perc_English_Language_Learner']],
...
sns.pairplot(school_data[['Average_Class_Size', 'Average_Salary', 'Perc_Economically_Disadvantaged', 'Perc_English_Language_Learner']])
    ...
    #exploratory analysis, choose one of the 4 measures from 3a to be an outcome variable, 
    #and a second measure to be a predictor variable. Then run a linear regression, print 
    #the summary, and write a sentence interpreting the results (does not need to be detailed, 
    #just practice retrieving the relevant info on predictor significance, etc.
	...
	#
	# c) Submit a link to your repository as your submission for the assignment on Canvas. Remember the note from Problem 0: you can keep your repo 
    #private and add me as a collaborator.